...
/**
 * Spark 'plugin' for use as a library within the Paper server implementation.
 *
 * <p>Paper provides:</p>
 * <ul>
 ...
 *     <li>call {@link #onCommand(CommandSender, String[])} when the spark command is executed</li>
 *     <li>call {@link #onTabComplete(CommandSender, String[])} when the spark command is tab completed</li>
...
public class PaperSparkPlugin implements SparkPlugin, AutoCloseable {
    ...
    // equivalent of ServerTickStartEvent
    public void onServerTickStart() {
        this.tickHook.onTick();
    }

    // equivalent of ServerTickEndEvent
